...
class PlayerTest {
    ...
    @Test
    void paneltyScoreStaysTheSame() {

       
        // calculate the expected score for later (should be the same)
    ...
    @Test
    void paneltyUiFreezeTime() {

        // call the method we are testing
        player.penalty();

        // check that the ui set freeze to the player for 3 seconds
